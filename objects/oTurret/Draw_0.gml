...
draw_sprite_ext(sTurretGun, image_index, x, y+8, scale * image_xscale * gun_scale * 0.8, scale*image_yscale * (2 - gun_scale)*-0.6, image_angle+SHADOW_ANGLE, c_black, SHADOW_ALPHA);
