...
if (tutorial_event <= 5) {
	...
	draw_text_transformed(display_get_gui_width()/2, display_get_gui_height()/3 + 30, tutorial_event_text[tutorial_event, 1], scale, scale, 0);
	
	if (add_prompt_alarm <= 0 and (tutorial_event == 0 or tutorial_event == 4)) {
