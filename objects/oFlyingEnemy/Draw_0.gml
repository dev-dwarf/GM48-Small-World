...
draw_sprite_ext(sprite_index, image_index, x, temp_y + sprite_height, image_xscale * scale * 0.8, -1 * image_yscale * scale * 0.6 + 0.1 * sin(current_time * 2 * pi * 0.001), -image_angle, c_black, SHADOW_ALPHA);
